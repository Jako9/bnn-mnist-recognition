...
\centering
\begin{tikzpicture}[minimum height=0.8cm,minimum width=3cm,line width = 0.25mm]
\node[rectangle,draw=black,color=preload] at(0,2)(bl1) {Binarized Linear (500)};
\node[rectangle,draw=black, below of=bl1] (bn1) {Batch Norm};
\node[rectangle,draw=black, below of=bn1] (a1) {Activation};

\node[rectangle,draw=black,color=preload] at (4,0)(bl2) {Binarized Linear (1024)};
\node[rectangle,draw=black, below of=bl2] (bn2) {Batch Norm};
\node[rectangle,draw=black, below of=bn2] (a2) {Activation};

\node[rectangle,draw=black,color=preload] at (8,-2)(bl3) {Binarized Linear (1024)};
\node[rectangle,draw=black, below of=bl3] (bn3) {Batch Norm};
\node[rectangle,draw=black, below of=bn3] (a3) {Activation};

\node[rectangle,draw=black] at (11,0)(l) {Linear (1024)};
\node[rectangle,draw=black, below of=l] (sm) {softmax};

\draw [->,line width = 0.4mm] (a1) -- (bl2) ;
\draw [->,line width = 0.4mm] (a2) -- (bl3) ;
\draw [->,line width = 0.4mm] (a3.east) -- (13,-4) -- (13,0) -- (l) ;
\end{tikzpicture}
\end{frame}
