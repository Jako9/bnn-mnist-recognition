...
\begin{figure}[H]
	...
	\label{fig:bln}
\end{figure}
Wie in Abbildung \ref{fig:bln} zu erkennen, erhält die binäre Linear-Layer, wie normaler Weise \textit{nn.linear}, die Ausgaben der vorherigen Schicht. Diese werden im Folgenden über die Vorzeichenfunktion binarisiert.\\
